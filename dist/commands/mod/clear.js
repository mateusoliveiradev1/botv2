        ...
        try {
            ...
            if ('bulkDelete' in channel) {
                ...
                await interaction.reply({
                    embeds: [embeds_1.EmbedFactory.success('Limpeza Concluída', `🗑️ **${amount}** mensagens foram removidas.`)]
                });
            ...
            await interaction.reply({ embeds: [embeds_1.EmbedFactory.error('Erro ao limpar mensagens (talvez sejam muito antigas).')], ephemeral: true });
        }
    }
};
